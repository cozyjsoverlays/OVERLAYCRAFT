...
function tagsFor(noun, cats) {
  ...
  if (cats.includes("badges")) {
    return [
      "Twitch Sub Badges", "Twitch Emotes", "Animated Emotes", "Sub Badge Set",
      "Twitch Badges", "Emote Pack", "Twitch Emote Pack", "Cute Emotes",
      "Streamer Emotes", "Bit Badges", "Twitch Sub Badge", "Kick Emotes",
      "Animated Sub Badges",
    ];
  }
  const base = [
